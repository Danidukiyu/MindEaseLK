...
function RootLayoutNav() {
  useEffect(() => {
    ...
    const shouldIgnore = (message: string, source?: string | null) => {
      const isOriginError = /origin not allowed/i.test(message || "");
      const isExtensionSource = (source || "").startsWith("chrome-extension://");
      return isOriginError && isExtensionSource;
    };
